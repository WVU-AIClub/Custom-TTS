# Source: https://github.com/natlamir/ProjectFiles/blob/main/Piper/CreateTranscript.py
...
wav_files = [file for file in os.listdir('wavs') if file.endswith(".wav")]
...
with open("metadata.csv", "w") as transcript_file:
    ...
    for wav_file in wav_files:
        ...
        result = model.transcribe("wavs/" + wav_file)
